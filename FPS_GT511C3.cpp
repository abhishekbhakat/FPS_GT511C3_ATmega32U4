/*
	FPS_GT511C3.cpp v1.0 - Library example for controlling the GT-511C3 Finger Print Scanner (FPS) using (ATmega32U4 Processor) Arduino Board Leonardo, Arduino Board Micro and Arduino Board Yun.
